...
async function login(name,password){
    return axios.get(`${process.env.BACKEND_URL}/login`,{params: {
    userName: name,
    userPass: password
...
async function logout(){
    return axios.get(`${process.env.BACKEND_URL}/logout`,{params:{user:Cookies.get('userId')}},{withCredentials:true})
    .then((response) => {
